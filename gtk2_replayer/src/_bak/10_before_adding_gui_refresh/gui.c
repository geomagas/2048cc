 ...
 * ---------------------------------------------------
 */
gboolean gui_refresh_scores( Gui *gui )
{
	char markup[SZMAX_DBGMSG] = {'\0'};
 ...
 * ---------------------------------------------------
 */
gboolean gui_refresh_prevnext( Gui *gui )
{
 ...
 * ---------------------------------------------------
 */
gboolean gui_refresh_statusbar( const Gui *gui )
{
	if ( NULL == gui ) {
		DBG_STDERR_MSG( "NULL pointer argument (gui)!" );
		return FALSE;
...
//	gui_resize_board( gui );
	gui_refresh_board( gui );
	gui_refresh_prevnext( gui );
	gui_refresh_statusbar( gui );
...
gboolean gui_set_gamedata_from_fname( Gui *gui, char *fname )
{
	...
	gui->hasloadedfile = gamedata_set_from_fname( gui->gamedata, fname );
 ...
 * ---------------------------------------------------
 */
gboolean gui_has_loaded_file( const Gui *gui )
{
	if ( NULL == gui ) {
		DBG_STDERR_MSG( "NULL pointer argument (gui)!" );
		return FALSE;
