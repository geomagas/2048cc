...
#define GETTEXT_PACKAGE  "2048cc_gtk2_viewer"   /* our app's translation text-domain */
 ...
 * ---------------------------------------------------
 */
static gboolean gui_locale_init_gettext(
 ...
 * ---------------------------------------------------
 */
static void gui_locale_set_environment(
	const gchar  *locale,
	const gchar  *lang,
	...
	)
{
	...
	dbg_print_locale_environment( "Locale Environment changed to Greek:" );
...
*/
	...
	if ( !gui_locale_init_gettext( GETTEXT_PACKAGE, LOCALEDIR, OUTCODESET) ) {
