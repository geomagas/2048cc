...
#define TXTF_DLG_JUMPTO_RANGE     _("%ld - %ld")
#define TXTF_DLG_JUMPTO_CURRENT   _("%ld")
#define TXTF_DLG_JUMPTO_SUGGEST   _("%ld")
...
#define TXT_ERR_INVALID_JUMPTO    _("That was not a valid move!")
