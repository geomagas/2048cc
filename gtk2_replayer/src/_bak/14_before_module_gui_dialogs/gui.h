...
/* dialogs */
extern GtkWidget     *gui_get_dlgJumpto_root( Gui *gui );
extern GtkWidget     *gui_get_dlgJumpto_lblRange( Gui *gui );
extern GtkWidget     *gui_get_dlgJumpto_lblCurrent( Gui *gui );
extern GtkWidget     *gui_get_dlgJumpto_te( Gui *gui );
