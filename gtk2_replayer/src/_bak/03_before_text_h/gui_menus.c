 ...
 * ---------------------------------------------------
 */
static void on_activate_miQuit( GtkWidget *mi, Gui *gui )
{
 ...
 * ---------------------------------------------------
 */
static void on_activate_miEnglish( GtkWidget *mi, Gui *gui )
{
 ...
 * ---------------------------------------------------
 */
static void on_activate_miGreek( GtkWidget *mi, Gui *gui )
{
	GuiLocale *guilocale = gui_get_locale( gui );
	GuiMenus  *guimenus  = gui_get_menus( gui );
 ...
 * ---------------------------------------------------
 */
static void on_activate_miEnvironment( GtkWidget *mi, Gui *gui )
{
	GuiLocale *guilocale = gui_get_locale( gui );
	GuiMenus  *guimenus  = gui_get_menus( gui );
 ...
 * ---------------------------------------------------
 */
static void on_activate_miAbout( GtkWidget *mi, Gui *gui )
{
