...
//	}
	...
	|| gui_get_isPlayPressed( gui )
		...
		gtk_widget_set_sensitive( gui->playback.toolPlay, FALSE );
	}
	else {
		gtk_widget_set_sensitive( gui->playback.toolPlay, TRUE );
	}
	...
	&& !gui_get_isStopPressed( gui )
		...
		gtk_widget_set_sensitive( gui->playback.toolPause, TRUE );
		gtk_widget_set_sensitive( gui->playback.toolStop, TRUE );
	}
	else {
		gtk_widget_set_sensitive( gui->playback.toolPause, FALSE );
		gtk_widget_set_sensitive( gui->playback.toolStop, FALSE );
	}
